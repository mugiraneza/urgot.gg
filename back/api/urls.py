...
urlpatterns = [
    ...
    path("front/matches/<str:match_id>/", views.FrontMatchDetailView.as_view(), name="front-match-detail"),
    path("front/recent-riot-ids/", views.RecentRiotIdsView.as_view(), name="front-recent-riot-ids"),
    ...
    path("search/findusmmoner-puid/", views.FindPuidView.as_view(), name='findusmmoner-puid'),
